...
% Also this function gets the centroids of the detected vehicles which
...
function [out1, out2] = featureExtracter(BinaryVideo, VideoFrames, Orig_Patch_Height, Orig_Patch_Width, Orig_Features)
    ...
    for frameNum = 1 : Num_of_Frames
        ...
        if cc.NumObjects ~= 0
            ...
            point(frameNum, :) = point(frameNum - 1, :);
        end
